  ...
  return (
    <Layout>
      <motion.div
        ...
        className={`w-full min-h-screen flex border-r ${theme === 'dark' ? 'bg-[rgba(17,27,33)] border-gray-600 text-white' : 'bg-gray-100 border-gray-200 text-black'}`}
      >
        <div className="w-full rounded-lg p-6">
          ...
          <div className="space-y-6">
            ...
            <div
              className={`relative ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} p-4 shadow-sm rounded-lg`}
            >
              <label
                htmlFor="name"
              ...
              <div className="flex items-center">
                {isEditingName ? (
                  <input
                    ...
                    className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring focus:ring-green-500 ${theme === 'dark' ? 'bg-gray-700  text-white' : 'bg-white text-black'}`}
                  />
                ) : (
                ...
                {isEditingName ? (
                  <>
                    ...
                    >
                      <FaCheck className="h5 w-5 text-green-500" />
                    </button>
                    ...
                    <button
                      ...
                      className="ml-2 focus:outline-none"
                    >
                      <FaSmile className="h5 w-5 text-yellow-500" />
                    </button>
                    ...
                    <button
                      ...
                      className="ml-2 focus:outline-none"
                    >
                      <MdCancel className="h5 w-5 text-gray-500" />
                    </button>
                  </>
                ) : (
                  <button
                    ...
                    className="ml-2 focus:outline-none"
                  >
                    <FaPencilAlt className="h5 w-5 text-gray-500" />
                  </button>
                )}
              </div>
